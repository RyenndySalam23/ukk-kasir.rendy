    ...
    <div class="glass-card p-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <a href="index.php?page=produk" class="text-muted small">Lihat detail <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card p-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <a href="index.php?page=user_kelola" class="text-muted small">Lihat detail <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card p-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <a href="index.php?page=pegawai" class="text-muted small">Lihat detail <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
    </div>
