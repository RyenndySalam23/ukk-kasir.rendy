    ...
    <div class="glass-card p-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <a href="?" class="text-muted small">(Akses Kasir) <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card p-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <a href="adminpage.php?page=user_kelola" class="text-muted small">Lihat detail <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card p-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <a href="adminpage.php?page=pegawai" class="text-muted small">Lihat detail <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
    </div>
